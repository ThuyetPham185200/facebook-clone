...
type authenticationManager struct {
	credStore      CredentialsStore // abstract interface to Credentials DB
	userService    UserService      // external User Service (profile, metadata)
	sessionManager SessionManager   // token & session management
}

func NewAuthenticationManager(cs CredentialsStore, us UserService, sm SessionManager) AuthenticationManager {
