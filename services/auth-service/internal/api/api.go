...
func (api *AuthAPI) handleLogout(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, map[string]string{"message": "Logged out from current session"})
}
...
func (api *AuthAPI) handleLogoutAll(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, map[string]string{"message": "Logged out from all sessions"})
}
...
func (api *AuthAPI) handleRequestPasswordReset(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, map[string]string{"message": "If this email exists, a reset link has been sent"})
}
